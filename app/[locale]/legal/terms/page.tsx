      ...
      <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[minmax(0,1fr)_20rem]">
        ...
        <aside className="glass h-fit rounded-[var(--radius-xl)] p-6 lg:sticky lg:top-24">
          ...
          <div className="mt-5 grid gap-3">
            <PlatformItem title="Apple" copy="App Store rules, iCloud, subscriptions" />
            <PlatformItem title="Android" copy="Google Play rules, Android permissions" />
            <PlatformItem title="BabyLeveling" copy="Website, waitlist, app support" />
          </div>
          <Link
            href={related.href}
