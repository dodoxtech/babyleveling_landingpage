    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Pricing model", "Freemium", "Subscription", "Freemium", "Freemium", "Paid upfront"],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "BabyLeveling is live now on the App Store, free to download, with an optional Premium upgrade for cloud sync and family sharing.",
