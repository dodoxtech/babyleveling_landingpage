 ...
 * Sharing") and the "co-op quest" framing in docs/planning/01-strategy.md §3 (S9).
 * Every role uses an existing `public/assets` activity icon as its party-member glyph.
...
const FAMILY_ROLE_BASE: FamilyRoleBase[] = [
  ...
  { id: "partner", sprite: "icon.heart-pulse" },
  { id: "grandparent", sprite: "icon.book" },
